...
namespace IKAPICore.Controllers
{
    ...
    public class ShopsController : ControllerBase
    {
        ...
        public ShopsController(itkotdbContext context)
        {
            _context = context;
        }
        ...
        {
            return await _context.Shops.Include(n=>n.Place).Include(n=>n.Products.Take(6)).ThenInclude(n=>n.ProductImages).ToListAsync();
        }
